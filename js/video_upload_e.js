var handleUpload_e = function(event) {
			...
			if(this.status == 200) {
				...
				for (var i = 0; i < uploaded.length; ++i) {
					...
					var player = document.getElementById('preVideo');
      				...
      				mp4Vid.setAttribute('src', "../../file_upload/video/events/"+uploaded[i]);
...
window.addEventListener('load', function(event){
	var submit = document.getElementById('submit_e');

	submit.addEventListener('click', handleUpload_e);
});