...
@section('main-content')
    ...
    <section id="blog" class="blog-section">
        ...
        <div class="box-semua" style="background-image:url('img/backhouse.jpg');-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;">
                  ...
                  <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item {{ $stat_active }}">
                        ...
                        <div class="box-blog-content">
                            ...
                            <h1 class="font-color-ungu font-bold">HOUSE RULES</h1>
